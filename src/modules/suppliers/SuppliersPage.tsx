...
function SuppliersContent({ year, setYear }: { year: number | null; setYear: (y: number | null) => void }) {
...
export default function SuppliersPage() {
  ...
  return (
    <PageDataProvider module="suppliers" queries={PAGE_QUERIES.suppliers} params={{ year }}>
      <SuppliersContent year={year} setYear={setYear} />
    </PageDataProvider>
  )
}
